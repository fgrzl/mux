...
// Route constructs a RouteOptions value used by these unit tests.
// We add convenience methods on *RouteOptions to keep tests succinct while
// avoiding importing the top-level mux package.
func Route(method, pattern string) *RouteOptions {
	return &RouteOptions{Method: method, Pattern: pattern}
}

func (ro *RouteOptions) WithQueryParam(name string, example any) *RouteOptions {
	if ro.Parameters == nil {
		ro.Parameters = []*openapi.ParameterObject{}
	}
	ro.Parameters = append(ro.Parameters, &openapi.ParameterObject{Name: name, In: "query", Example: example})
	return ro
}

func (ro *RouteOptions) WithHeaderParam(name string, example any, required bool) *RouteOptions {
	if ro.Parameters == nil {
		ro.Parameters = []*openapi.ParameterObject{}
	}
	ro.Parameters = append(ro.Parameters, &openapi.ParameterObject{Name: name, In: "header", Example: example, Required: required})
	return ro
}

func (ro *RouteOptions) WithPathParam(name string, example any) *RouteOptions {
	if ro.Parameters == nil {
		ro.Parameters = []*openapi.ParameterObject{}
	}
	ro.Parameters = append(ro.Parameters, &openapi.ParameterObject{Name: name, In: "path", Example: example, Required: true})
	return ro
}
